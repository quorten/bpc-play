...
IVint64 iv_dotshr3_v2i32(IVVec2D_i32 *a, IVVec2D_i32 *b, IVuint32 q)
{
...
IVint64 iv_magn2qshr2_v2i32(IVPoint2D_i32 *a, IVuint32 q)
{
				      ...
				      IVuint32 q)
{
  ...
  iv_rf_NLine_Eqs_v2i32(&nline, &b->d[0], q);
