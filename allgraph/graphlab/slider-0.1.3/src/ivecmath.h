...
FFA_TYPE(IVRay_v2i32, 2);
FFA_TYPE(IVRay_v3i32, 3);
typedef IVEqs_v2i32_ar2 IVSys2_Eqs_v2i32;
typedef IVEqs_v3i32_ar3 IVSys3_Eqs_v3i32;
typedef IVRay_v2i32_ar2 IVSys2_Ray_v2i32;
typedef IVRay_v3i32_ar3 IVSys3_Ray_v3i32;

/* TODO: Define equations using in-plane vectors, and create
   corresponding solver functions for those.  */
